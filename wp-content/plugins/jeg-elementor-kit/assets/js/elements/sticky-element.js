		...
		class i extends elementorModules.frontend.handlers.Base {
			...
			runSticky() {
				...
				const e = this,
					...
					n = i.hasClass("jkit-sticky-element-on--down")
						? "down"
						: i.hasClass("jkit-sticky-element-on--up")
						? "up"
						: "both",
				...
				(e.stickyTop = r),
					...
					t(window).on("load resize scroll", i, function (d) {
						...
						if (
							("fixed" === o &&
								"resize" === d.type &&
								(i.parent().hasClass("wrapper-sticky-fixed") &&
									(i.unwrap(),
								...
								i.css("height", e.height),
								i.css("margin", e.margin)),
							"string" == typeof s.jkit_sticky_device &&
								(s.jkit_sticky_device = [s.jkit_sticky_device]),
						...
						if (
							!i.hasClass("sticky-pinned") &&
							((r = i.offset().top), void 0 !== s)
						) {
							if (void 0 !== s.jkit_sticky_top_position) {
								...
								e.length &&
									((r -= e.height()),
									i.css("--wpadminbar-height", e.height() + "px"));
							}
							void 0 !== s.jkit_sticky_bottom_position &&
								(r += s.jkit_sticky_bottom_position.size);
						}
						("down" === n && k < p) || ("up" === n && k > p)
							? (i.css("position", o),
							  i.addClass("sticky-pinned"),
							  e.hideOnScroll(l, c, n, d, i))
							: "both" === n && "sticky" === o
							? (i.css("position", o), i.addClass("sticky-pinned"))
							: (i.css("position", "relative"),
			...
			hideOnScroll(e, t, i, s, n) {
				if ("scroll" === s.type) {
					if ("down" === i) {
						if (
							this.stickyTop + this.height >= t &&
							n.hasClass("jkit-sticky-element--threshold")
						)
