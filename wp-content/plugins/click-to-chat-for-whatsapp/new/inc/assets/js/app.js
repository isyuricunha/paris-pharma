!(function (t) {
	t(function () {
						...
						function (e) {
							e.preventDefault(),
								document.querySelector("#ctc_opt")
									? t("#ctc_opt").is(":checked") || a("g_optin")
										? v(c)
				...
				if (t(".ht_ctc_chat_greetings_box").length) {
					...
					document.dispatchEvent(
						new CustomEvent("ht_ctc_event_after_chat_displayed", {
							detail: { ctc: s, greetings_open: d, greetings_close: l },
						})
					),
						s.g_init &&
							"open" == s.g_init &&
							"user_closed" !== a("g_user_action") &&
							d("init"),
						t(document).on(
							"click",
		...
		function f() {
			document.querySelector(".ht_ctc_notification") &&
				(i("n_badge", "stop"), t(".ht_ctc_notification").remove());
		}
		function p(t) {
			...
			if (s.ga || s.ga4)
				if ("undefined" != typeof gtag)
					s.ga4
						? gtag("event", "click to chat", { number: n, title: c, url: e })
						: gtag("event", _, { event_category: o, event_label: a });
				else if ("undefined" != typeof ga && void 0 !== ga.getAll) {
					ga.getAll()[0].send("event", o, _, a);
				} else
					"undefined" != typeof __gaTracker &&
						__gaTracker("send", "event", o, _, a);
		...
		function v(c) {
			...
			c.hasAttribute("data-number") && (_ = c.getAttribute("data-number")),
				c.hasAttribute("data-pre_filled") &&
					(a = c.getAttribute("data-pre_filled"));
			try {
				(a = (a = a.replaceAll("%", "%25")).replace(/\[url]/gi, e)),
					(a = encodeURIComponent(decodeURI(a)));
			} catch (t) {}
			if ("" != _) {
				...
				"yes" == n
					? (s.url_structure_m &&
							((i = "whatsapp://send?phone=" + _ + "&text=" + a),
							(r = "_self")),
					  s.custom_url_m && "" !== s.custom_url_m && (i = s.custom_url_m))
					: (s.url_structure_d &&
							(i = "https://web.whatsapp.com/send?phone=" + _ + "&text=" + a),
